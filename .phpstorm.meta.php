...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\antinganggur-betatest\authorization\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\antinganggur-betatest\\authorization\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'register','register.submit','login',
'login.submit','logout','profile.show','profile.update','profile.experience',
'profile.experience.store','profile.experience.edit','profile.experience.update','profile.experience.delete','profile.education',
'profile.cv','storage.local',);
        registerArgumentsSet('views', 
'aboutus','auth.login','auth.register','contact','home',
'layouts.app','layouts.partials.footer','layouts.partials.header','profile.cv','profile.education',
'profile.experience','profile.experience.edit','profile.partials.sidebar','profile.show','welcome',
