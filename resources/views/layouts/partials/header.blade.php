    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                <div class="flex-shrink-0">
                    <a href="{{ url('/') }}" class="flex items-center">
                        <img class="h-8 sm:h-10 w-auto" src="{{ asset('asset/page/Vector.png') }}" alt="AntiNganggur Logo">
                        <div class="ml-2">
                ...
                <div class="hidden md:flex items-center">
                    <a href="{{ route('login') }}" class="ml-6 inline-flex items-center justify-center px-5 lg:px-6 py-2.5 border-2 border-orange-500 text-[15px] font-semibold rounded-lg text-orange-500 bg-white hover:bg-orange-500 hover:text-white transition-colors duration-200 ease-in-out shadow-sm">
                        Masuk
                    </a>
                </div>
                @endguest
                ...
                <div class="hidden md:flex items-center ml-6 relative">
                    ...
                    <div id="user-dropdown-menu"
                        ...
                        <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-150" role="menuitem" id="user-menu-item-0">Profil Anda</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <a href="{{ route('logout') }}"
                               onclick="event.preventDefault(); this.closest('form').submit();"
                               class="block px-4 py-2 text-sm text-slate-700 hover:bg-orange-50 hover:text-orange-600 transition-colors duration-150" role="menuitem" id="user-menu-item-2">
                                Keluar
                            </a>
                        </form>
                    </div>
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <div class="px-5">
                    <a href="{{ route('login') }}" class="block w-full text-center px-5 py-2.5 border-2 border-orange-500 text-base font-semibold rounded-lg text-orange-500 bg-white hover:bg-orange-500 hover:text-white transition-colors duration-200 ease-in-out">
                        Masuk
                    </a>
                </div>
            </div>
