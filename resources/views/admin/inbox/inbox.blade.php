            ...
            <thead class="text-xs text-gray-700 uppercase">
                <tr>
                    <th class="py-3 px-6 w-16 font-semibold">
                        <a href="{{ route('admin.inbox', ['sort' => 'id', 'direction' => $sortBy == 'id' && $direction == 'asc' ? 'desc' : 'asc']) }}" class="flex items-center gap-2">
                            <span>Id</span>
                            @if ($sortBy == 'id')
                                @if ($direction == 'asc')
                                    <img src="{{ asset('asset/admin/ArrowUp.png') }}" alt="Ascending" class="w-2 h-2">
                                @else
                                    <img src="{{ asset('asset/admin/ArrowDown.png') }}" alt="Descending" class="w-2 h-2">
                                @endif
                            @endif
                        </a>
                    </th>
