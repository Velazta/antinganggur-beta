    ...
    <div class="w-full bg-gradient-to-br from-slate-50 to-gray-200 px-4 py-16 sm:py-40">
        ...
        <div id="profile-card"
            ...
            <div class="relative w-full max-w-xs lg:w-2/5 flex-shrink-0">
                ...
                <img src="{{ asset('asset/page/FotoMember.png') }}" alt="Foto Member"
            ...
            <div class="w-full lg:w-3/5 flex flex-col justify-between self-stretch">
                ...
                <div>
                    ...
                    <h1 class="text-4xl lg:text-5xl font-extrabold text-gray-800 tracking-tight">Rizky Amalia</h1>
                ...
                <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
                    <div class="flex space-x-5">
                         <a href="mailto:ravelinlutfhanrlsp@gmail.com" class="relative group h-7 w-7">
                            <img src="{{ asset('asset/page/Gmailgray.png') }}" alt="Email" class="absolute inset-0 w-full h-full object-contain opacity-100 group-hover:opacity-0 transition-opacity duration-300">
                            <img src="{{ asset('asset/page/Gmailblue.png') }}" alt="Email Hover" class="absolute inset-0 w-full h-full object-contain opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </a>

                        <a href="https://www.instagram.com/ravelinluth/" class="relative group h-7 w-7">
                            <img src="{{ asset('asset/page/Instagramgray.png') }}" alt="Instagram" class="absolute inset-0 w-full h-full object-contain opacity-100 group-hover:opacity-0 transition-opacity duration-300">
                            <img src="{{ asset('asset/page/Instagramblue.png') }}" alt="Instagram Hover" class="absolute inset-0 w-full h-full object-contain opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </a>
                        <a href="https://www.linkedin.com/in/ravelin-syach-97460028a/" class="relative group h-7 w-7">
                            <img src="{{ asset('asset/page/LinkedIngray.png') }}" alt="LinkedIn" class="absolute inset-0 w-full h-full object-contain opacity-100 group-hover:opacity-0 transition-opacity duration-300">
                            <img src="{{ asset('asset/page/LinkedInblue.png') }}" alt="LinkedIn Hover" class="absolute inset-0 w-full h-full object-contain opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        </a>
                    </div>
